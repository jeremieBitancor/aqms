...
class PowerHourlyAveListView(generics.ListAPIView):
    ...
    queryset = Aqms.objects.values(hour=ExtractHour('date_time'), day=ExtractDay('date_time'), month=ExtractMonth(
        'date_time'), year=ExtractYear('date_time')).annotate(t_wat_pz=Sum('wat_pz'), t_wat_wt=Sum('wat_wt'), t_wat_all=Sum(F('wat_pz')+F('wat_wt'))).order_by('hour')
...
class PowerDailyAveListView(generics.ListAPIView):
    ...
    queryset = Aqms.objects.values(week=ExtractWeek('date_time'), weekday=ExtractWeekDay('date_time')).annotate(
        t_wat_pz=Sum('wat_pz'), t_wat_wt=Sum('wat_wt'), t_wat_all=Sum(F('wat_pz')+F('wat_wt'))).order_by('weekday')
...
class PowerWeeklyAveListView(generics.ListAPIView):
    ...
    queryset = Aqms.objects.values(month=ExtractMonth('date_time'), week=ExtractWeek('date_time'), year=ExtractYear(
        'date_time')).annotate(t_wat_pz=Sum('wat_pz'), t_wat_wt=Sum('wat_wt'), t_wat_all=Sum(F('wat_pz')+F('wat_wt'))).order_by('week')
